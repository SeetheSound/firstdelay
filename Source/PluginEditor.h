...
/**
*/
class FirstDelayAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    FirstDelayAudioProcessorEditor (FirstDelayAudioProcessor&);
    ~FirstDelayAudioProcessorEditor() override;
